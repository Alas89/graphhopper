...
public class OSMReaderTest {
    ...
    @Test public void testMain() {
        ...
        assertEquals(n10, iter.node());
        assertEquals(88643, iter.distance(), 1);
        assertTrue(iter.next());
        assertEquals(n30, iter.node());
    ...
    @Test public void testWayReferencesNotExistingNode() {
        OSMReader reader = preProcess(init(new OSMReader(buildGraph(dir), 1000).
